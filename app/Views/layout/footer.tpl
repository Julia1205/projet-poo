...
<div class="container">
    <footer class="py-3 my-4" id="footer">
        <ul class="nav justify-content-center pb-3 mb-3" id="footer-list">
            ...
            <li class="nav-item text-muted"><a href="{base_url('/gcu')}" class="nav-link px-2 text-reset">GCU</a></li>
            <li class="nav-item text-muted"><a href="{base_url('/gdpr')}" class="nav-link px-2 text-reset">RGPD</a></li>
